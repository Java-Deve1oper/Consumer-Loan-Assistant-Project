...
private void computeButtonActionPerformed(final ActionEvent e)
{
...
newLoanButton.requestFocus();
    ...
    private void newLoanButtonActionPerformed(final ActionEvent e) {
    ...
    private void monthsButtonActionPerformed(final ActionEvent e) {
        // will compute months
    ...
    private void paymentButtonActionPerformed(final ActionEvent e) {
    ...
    private void balanceTextFieldActionPerformed(final ActionEvent e) {
        balanceTextField.transferFocus();
    }

    private void interestTextFieldActionPerformed(final ActionEvent e) {
        interestTextField.transferFocus();
    }

    private void monthsTextFieldActionPerformed(final ActionEvent e) {
        monthsTextField.transferFocus();
    }

    private void paymentTextFieldActionPerformed(final ActionEvent e) {
        paymentTextField.transferFocus();
    }

    private boolean validateDecimalNumber(final JTextField tf) {
